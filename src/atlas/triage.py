...
_RESPONSE_TEMPLATES: dict[str, str] = {
    "access": (
        ...
        "it accordingly.\n\n"
        "For time-sensitive access issues, call the IT helpline at ext. 4357 (HELP). "
        "For password resets, the self-service portal is available at password.example.com if your MFA is enrolled.\n\n"
